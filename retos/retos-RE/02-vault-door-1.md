...
```bash
Lo solucione con un metodo un tanto ineficaz, pero a fin de cuentas... sirve. Lo unico que hize fue analizar las posiciones segun el lenguaje de java en el codigo fuente.
